...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "Nueva consulta registrada";

		$host = isset($_SERVER['SERVER_NAME'])?$_SERVER['SERVER_NAME']:'localhost';
        $from_email ='forms@'.$host;
   		$this->mailer->setFrom($from_email,'Punta Green | Alquileres vacacionales',false);  
	...
	{
		$content = "Se registró una nueva consulta en Punta Green Web: \n\n";
